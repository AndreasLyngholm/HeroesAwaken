        ...
        <div class="row">
            <div class="small-16 columns">
                <div class="cta-text">
                    ...
                    <p> <span>dummy text!</span></p><a href="#" class="button cta-button">Try the Demo! <span>for Windows &amp; MacOS</span></a>
                </div>
            </div>
        </div>
    </div>
...
<footer class="main-footer">
    <div class="row">
        ...
        <div class="small-16 medium-4 columns">
            <a href="#"><img src="{{ asset('images/logo_footer.png') }}" alt="" class="footer-logo"/></a>
        </div>
        <!--//logo-->
        <!--copyright-->
        <div class="small-16 medium-6 columns">
