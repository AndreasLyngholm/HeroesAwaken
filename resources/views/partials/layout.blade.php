...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style.css') }}?v33">
...
@if( ! Request::is('admin*'))<a href="{{ route('download') }}"><img class="hide-for-small-only" style="position: absolute; right: 10rem; top: 0.5rem; z-index:2500; width: 10rem;" src="{{ asset('images/dl.png') }}"></a>@endif
