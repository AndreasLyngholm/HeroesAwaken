<header id="main-header" @if( ! Request::is('/')) style="background: url({{ asset('images/backgrounds/bg-menu.png') }}) repeat-x center top;" @endif>
    <div class="row">
        <div class="small-11 large-6 columns"><a href="{{ route('home') }}"><img src="{{ asset('images/logo_new_small.png') }}" alt="AwakenHeroes" style="width: 50%;" class="logo"></a></div>
